    ...
    <div class="w-[800px] mx-auto md:w-full">
        ...
        ">
            ...
            <div class="box">
                ...
                <dl>
                    <div>
                        <dt><span>Q-1</span>プリント写真について</dt>
                        <div class="answer">
                            <div>A</div>
                            <dd>プリント写真につきましては、構成以外の中から選ばせていただく場合もございますのでご了承ください。
                            </dd>
                        </div>
                    </div>
                    <div>
                        <dt><span>Q-2</span>スマホで観たり　遠く離れた両親にも観せたいです。</dt>
                        <div class="answer">
                            <div>A</div>
                            <dd>パッケージに同梱されている『 LINEアンケート 』をお送りいただいた方に<br />
                                「バースストーリー」の『動画』データをプレゼントさせていただきます。</dd>
                        </div>
                    </div>
                    <div>
                        <dt><span>Q-3</span>プリント写真のデータが欲しいです。</dt>
                        <div class="answer">
                            <div>A</div>
                            <dd>パッケージに同梱されている『 LINEアンケート 』をお送りいただいた方に<br />
                                プリント写真のデータもプレゼントさせていただきます。</dd>
                        </div>
                    </div>
                </dl>
            </div>
