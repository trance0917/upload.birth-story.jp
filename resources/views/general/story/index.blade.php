...
{{--    </div>--}}
    ...
    ">
        ...
        <li><a class="bg-slate-400" :href="'/faq?submission_type='+tbl_patient.mst_maternity.submission_type" target="_blank">よくある質問</a></li>
    </ul>
        ...
        ">
            ...
            <div class="space-y-[25px]">
                ...
                <div class="box">
                    ...
                    <div class="space-y-[10px] mt-[10px]" :class="{'opacity-60':sorting_key=='free'}">
                        <template v-for="(medium,medium_key) in tbl_patient.tbl_patient_mediums">
                ...
                <div class="box">
                    <h4><i class="fa-solid fa-pencil"></i>バースフォトにしたい写真を<span class="count">@{{ type_counts.photoart }}枚</span><span class="example" @click="is_overlay_photoart=true">写真例</span></h4>
...
{{--    <button class="block w-full fixed bottom-0 left-0 text-16px] py-[15px] font-bold text-white bg-slate-400" type="submit" value="2"><i class="fa-solid fa-download mr-[5px]"></i> 途中保存する</button>--}}
    ...
    <div v-if="is_overlay_photoart" class="z-20 flex items-center justify-center w-full h-full fixed top-0 left-0 bg-[#000000]/20" @click="is_overlay_photoart=false">
        <div class="w-[80%] p-[15px] border border-slate-300 bg-white">
            ...
            <div class="flex justify-center mb-[10px]">
                <div class="mr-[10px] w-[40%]"><img class="mx-auto" src="/images/sample-photoart-1.png" alt="" /></div>
                <div class="w-[40%]"><img class="mx-auto" src="/images/sample-photoart-2.png" alt="" /></div>
            </div>

            <div class="flex justify-center mb-[10px]">
                <div class="mr-[10px] w-[40%]"><img class="mx-auto" src="/images/sample-photoart-3.png" alt="" /></div>
                <div class="w-[40%]"><img class="mx-auto" src="/images/sample-photoart-4.png" alt="" /></div>
            </div>

            <div class="flex justify-center">
                <div class="mr-[10px] w-[40%]"><img class="mx-auto" src="/images/sample-photoart-5.png" alt="" /></div>
                <div class="w-[40%]"><img class="mx-auto" src="/images/sample-photoart-6.png" alt="" /></div>
            </div>
